...
$data = query("SELECT * FROM tbl_admin WHERE username != 'supersu'");
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <ul id="sidebarnav">
                        <li> <a class="waves-effect waves-dark" href="super-tambah.php" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Tambah Admin</span></a>
                        </li>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                <a href="super-edit.php?id=<?=$row['id_admin']?>"> <button type='button' class='btn btn-success'>EDIT </button></a>
                                                <a href="hapus-admin.php?id=<?=$row['id_admin']?>" onclick="return confirm('yakin??')";> <button type='button' class='btn btn-danger'>HAPUS</button></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <?php $angka++;?>
