                            ...
                            <div class="card-block">
                                <form method="post" action="" class="form-horizontal form-material">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="nip" placeholder="Masukkan NIP" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="password" placeholder="Masukkan Password" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
