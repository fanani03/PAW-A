...
(1, 'admin1', '123', 'Admin1 - Galih Pamungkas', '19041292', 'Jombang'),
(2, 'admin2', '1234', 'Admin2 - Fery Ananda', '192038123', 'Lamongan'),
(3, 'admin3', '12345', 'Admin3 - Budi Jatmiko', '12432423', 'Sidoarjo');
...
(4, 2001, 26, 'Ijazah', '38428364634937423437', 'IJAZAH FANANI sertifikat.pdf'),
(5, 2002, 27, 'SKHUN', '234254645457', 'SKHUN YOGA sertifikat.pdf'),
(6, 2004, 29, 'Ijazah', '57427547547456', 'IJAZAH NICOLA SERTIFIKAT.pdf'),
(7, 2004, 30, 'SKHUN', '8774884993', 'IJAZAH NICOLA SERTIFIKAT.pdf');
...
(26, 2001, 1, 'Ahmad Fanani', 'Ijazah', 'selesai', '2001-IJAZAH.pdf'),
(27, 2002, 2, 'Yoga Tirta', 'SKHUN', 'selesai', '2002-skhun.pdf'),
(28, 2003, 2, 'Teguh Budi Prasetya', 'Ijazah', 'proses', '2003-ijazahku.pdf'),
(29, 2004, 2, 'Nicola Yanni', 'Ijazah', 'selesai', '2004-IJAZAH.pdf'),
(30, 2004, 3, 'Nicola Yanni', 'SKHUN', 'selesai', '2004-IJAZAH.pdf'),
(31, 2001, NULL, 'Ahmad Fanani', 'SKHUN', 'pending', '2001-SKHUN.pdf'),
(32, 2003, NULL, 'Teguh Budi Prasetya', 'SKHUN', 'pending', '2003-skhunku.pdf');
...
--
ALTER TABLE `tbl_simpan`
  MODIFY `id_simpan` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tbl_transaksi`
--
ALTER TABLE `tbl_transaksi`
  MODIFY `id_transaksi` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
