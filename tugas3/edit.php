...
$nim = $_GET["nim"];
$data = query("SELECT * FROM tbl_143 WHERE nim=$nim");
...
<body>
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="collapse navbar-collapse " id="navbarNav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="#">RUBAH DATA MAHASISWA</a>
                </li>
                </ul>
            </div>
    </nav>
    ...
    <div class="container">
        ...
        <form method="post" action="">
            <input type="text" name="nim" id="nim" value="<?=  $data['0']['nim']?>" hidden>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="semester"value="<?=  $data['0']['semester']?>" id="semester"> 
            </div>
