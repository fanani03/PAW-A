...
<?php
        ...
        $name = $email = $gender = $comment = $website = $namaError = $emailError = $genderError = $websiteError = "";
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
  ...
  <br><br>
  Website: <input type="text" name="website"> <?= "<label for='website' style='color: red;''>$websiteError</label>"; ?>
  <br><br>
