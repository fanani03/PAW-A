                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="assets/images/users/user.png" alt="user" class="profile-pic m-r-10" /><?=$user?></a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                    <li> <a class="waves-effect waves-dark" href="super-dashboard.php" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Data Admin</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="super-tambah.php" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Tambah Admin</span></a>
                        </li>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">Profil Admin</h3>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <div class="form-group">
                                        <!-- <label class="col-md-6">ID Admin</label> -->
                                        <div class="col-md-6">
                                            <input type="text" name="id_admin" value="<?php echo $row['id_admin'];?>" class="form-control form-control-line" hidden>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-6">NIP</label>
                                        <div class="col-md-6">
                                            <input type="text" name="nip" value="<?php echo $row['nip'];?>" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
