...
if (isset($_POST["submit"])) {
    ...
    if (tambah($_POST) > 0) {
        ...
        echo "<script>
                    alert('NRP telah digunakan, data gagal dimasukkan')
                    document.location.href = 'index.php';
              </script>
            ";
    }
    ...
    <div class="container">
        ...
        <form method="POST" action="">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nrp" id="nrp" placeholder="NRP Mahasiswa" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="email" placeholder="email Mahasiswa" id="email" required> 
            </div>
