            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <!-- <li> <a class="waves-effect waves-dark" href="admin-kirim-file.php" aria-expanded="false"><i class="mdi mdi-file-send"></i><span class="hide-menu">Kirim File</span></a>
                        </li>
                        ...
                        <div class="card">
                            <div class="card-block">
                                <form method="post" action="" enctype="multipart/form-data" class="form-horizontal form-material">
                                    <input type="hidden" name="idtrans" id="idtrans" value="<?= $d['id_transaksi'];?>">
                                    <div class="form-group">
                                        <label for="nis" class="col-md-12">Nomor Induk Siswa</label>
                                        <div class="col-md-12">
                                            <input type="text" name="nis" id="nis" value="<?php echo $d['nis'];?>" class="form-control form-control-line" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="namaFile" class="col-md-12">Nama File</label>
                                        <div class="col-md-12">
                                            <input type="text" name="namaFile" id="namaFile" value="<?php echo $d['nama_file'];?>" class="form-control form-control-line" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button type="submit" name="simpan" class="btn btn-success">Kirim File</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
