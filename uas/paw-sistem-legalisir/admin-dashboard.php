                                                    ...
                                                    <?php if ($row['status'] == 'selesai') { 
                                                        ...
                                                        foreach($sql as $data) :
                                                            if ($data['id_transaksi'] == $row['id_transaksi']) {
                                                                //var_dump($data);
                                                                echo "<a href='download.php?berkas=" . $data['berkas'] . "&nama=" . $data['nis'] . "'><button type='button' class='btn btn-primary'>Download</button></a>";
                                                            }
                                                        endforeach;
                                                ...
                                                <td>
                                                    <?php
                                                        if ($row['status'] == 'pending') {
                                                           ...
                                                           echo "<a href='admin-kirim-file.php?id=$row[id_transaksi]'><button type='button' class='btn btn-primary'> Kirim File</button> </a>";
                                                            echo "<a href='update-status.php?id=$row[id_transaksi]&stat=tolak'><button type='button' class='btn btn-danger'>Tolak</button></a>";
